...
class PDF extends FPDF
{
	...
	function Header()
	{
        ...
        $this->SetFont('Arial','B',9);
        $this->Cell(27,6,utf8_decode('ACTIVIDAD'),1,0,'C',1);
        $this->Cell(33,6,utf8_decode('U/COBRO'),1,0,'C',1);
        $this->Cell(33,6,utf8_decode('CANTIDAD'),1,0,'C',1);
        $this->Cell(33,6,utf8_decode('PRECIO'),1,0,'C',1);
