                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Unidad de Cobro</li>
                        </ol>
                    </div>
...
foreach ($cobros as $fila) {
  ...
  $Filas.="<tr>
                <td style='color: #1488fc ; font-weight:bold; padding-left:30px;'>$id_unidad</td>
                <td>$actividad
                <input type='hidden' id='actividad$id_unidad' value='$id_actividad'>
                </td>
                <td>$nombre
                <input type='hidden' id='nombre$id_unidad' value='$nombre'>
                </td>
                <td>$$coste
                <input type='hidden' id='costo$id_unidad' value='$coste'>
                </td>
                <td>$fecha</td>
                <td>
                     <form id='id_unidad' style='display:inline-block;' data-toggle='tooltip' title='Editar'>
                     <input type='hidden' id='nombre$id_unidad' value='$nombre'>
                     <span id='$id_unidad'  onClick='editar(this.id)' class='btn btn-sm btn-outline-secondary p-t-0 p-b-0'  data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i></span>
                     </form>
                     <form action='complementos/delete.php' method='post' style='display:inline-block;'>
                     <input type='hidden' name='id' value='$id_unidad'>
                     <input type='hidden' name='accion' value='unidades'>
                     <button data-toggle='tooltip' title='Eliminar Folio $id_unidad' onclick='eliminar(event)' class='btn btn-sm btn-outline-secondary p-t-0 p-b-0' id='Agregar'> <i class='fas fa-trash-alt'></i></button>
                     </form>
                </td>
          </tr>";
} ?>
                        ...
                        <div class="card">
                            ...
                            <div class="card-body">
                                <div class="col-12" style="text-align: right;">
                                    <button  class="btn btn-sm" style="background:  #2766ae; color: white; font-size: 0.9em;" data-toggle="modal" data-target="#modal-agregar"><i class="fas fa-plus"></i> Añadir Unidad de Cobro</button>
                                            ...
                                            <div class="modal-body">
                                               ...
                                               <form action="complementos/updates.php" method="post">    
                                                    <div class="form-group">
                                                        <h2 class="h2-responsive product-name m-t-10"><strong>ACTIVIDAD</strong></h2>
                                                        <select name="id_actividad" id="actividad" class="form-control"></select>
                                                        <h2 class="h2-responsive product-name m-t-10"><strong>Unidad de Cobro</strong></h2>
                                                        <select name="unidad" class="form-control" id="editar_unidad">
                                                            <option id="select_unidad" selected="true"></option>
                                                        ...
                                                        <h2 class="h2-responsive product-name m-t-10"><strong>Coste de la Actividad</strong></h2>
                                                        <input type="number" class="form-control" id="input_costo" step="0.01" name="Coste">
             ...
             <div id="modal-agregar" class="modal fade bs-example-modal-lg" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none; border-radius: 20px;">
                <form action="unidades.php" method="post">
                        <div class="modal-dialog modal-xl">
                                        <div class="modal-content" style="background: url('../assets/images/gallery/unidades.png'); background-repeat: no-repeat; background-size: 100%;">
                                          <div class="row">
                         ...
                         ?>
                          <h3 class="h1-responsive text-info"><strong>REGISTRO DE UNIDAD DE COBRO</strong></h3>
                         ...
                         {    $nombre=$fila['nombre'];
                              $id_actividad=$fila['id_actividad'];
                             echo "<option value='$id_actividad'>$nombre</option>";
                         }  
                                                            ?>
                                                        </select>
                                                        <h2 class="h2-responsive product-name m-t-10"><strong>Unidad de Cobro</strong></h2>
                                                        ...
                                                        <h2 class="h2-responsive product-name m-t-10"><strong>Precio M.N.</strong></h2>
                                                        <input type="number" class="form-control" name="Costo" step="0.01" placeholder="Define el coste para la unidad de Cobro" required>
    ...
    <?php 
    if ($cont>0) {
         echo "<script>swal('LISTO!', 'Unidad de Cobro Registrada exitosamente', 'success')</script>";
     } ?>
    ...
    <script>
      ...
      {   
         ...
         var id_actividad=$('#actividad'+id).val()
         

        

         $("#input_nombre").attr("value",nombre)
         $("#input_costo").attr("value",costo)
         


          $("#id_elemento").attr("value",id)
          $("#select_unidad").attr("value",nombre)
          $("#select_unidad").html(nombre)
