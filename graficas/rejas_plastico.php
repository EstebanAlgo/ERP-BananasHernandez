...
<head>
    ...
    <title>Gráficas Rejas de Plástico</title>
    <!-- Bootstrap Core CSS -->
...
<?php
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Rejas de Plástico</li>
                        </ol>
                    </div>
  ...
  <tbody>
    <tr>
      ...
      <td class="a2018 txtinfo4"><?php echo $TREPLASENERO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASENERO19 ?></td>
    </tr>

    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">FEBRERO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASFEBRERO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASFEBRERO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">MARZO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASMARZO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASMARZO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">ABRIL</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASABRIL18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASABRIL19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">MAYO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASMAYO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASMAYO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">JUNIO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASJUNIO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASJUNIO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">JULIO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASJULIO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASJULIO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">AGOSTO</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASAGOSTO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASAGOSTO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">SEPTIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASSEPTIEMBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASSEPTIEMBRE19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">OCTUBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASOCTUBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASOCTUBRE19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">NOVIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASNOVIEMBRE18  ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASNOVIEMBRE19  ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">DICIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREPLASDICIEMBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREPLASDICIEMBRE19 ?></td>
    </tr>
    <tr>
      <th style="background: #1164F4; color: white;" scope="row">TOTAL</th>
      <td style="background: #A9CCE3; font-weight: bold;" class="txtinfo3"><?php echo $TREPLAS2018; ?></td>
      <td style="background: #A9CCE3; font-weight: bold;" class="txtinfo3"><?php echo $TREPLAS2019; ?></td>
    </tr>
  </tbody>
</table>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <h4 class="card-title">Rejas de Plástico</h4>
                                    <div class="ml-auto">
    ...
    <script>
        ...
        data: [{
            period: '2018',
            Enero: <?php echo $TREPLASENERO18; ?>,
                    Febrero: <?php echo $TREPLASFEBRERO18; ?>,
                    Marzo: <?php echo $TREPLASMARZO18; ?>,
                    Abril: <?php echo $TREPLASABRIL18; ?>,
                    Mayo: <?php echo $TREPLASMAYO18; ?>,
                    Junio: <?php echo $TREPLASJUNIO18; ?>,
                    Julio: <?php echo $TREPLASJULIO18; ?>,
                    Agosto:<?php echo $TREPLASAGOSTO18; ?>,
                    Septiembre:<?php echo $TREPLASSEPTIEMBRE18; ?>,
                    Octubre:<?php echo $TREPLASOCTUBRE18; ?>,
                    Noviembre:<?php echo $TREPLASNOVIEMBRE18; ?>,
                    Diciembre:<?php echo $TREPLASDICIEMBRE18; ?>
        }, {
            period: '2019',
            Enero: <?php echo $TREPLASENERO19; ?>,
                    Febrero: <?php echo $TREPLASFEBRERO19; ?>,
                    Marzo: <?php echo $TREPLASMARZO19; ?>,
                    Abril: <?php echo $TREPLASABRIL19; ?>,
                    Mayo: <?php echo $TREPLASMAYO19; ?>,
                    Junio: <?php echo $TREPLASJUNIO19; ?>,
                    Julio: <?php echo $TREPLASJULIO19; ?>,
                    Agosto:<?php echo $TREPLASAGOSTO19; ?>,
                    Septiembre:<?php echo $TREPLASSEPTIEMBRE19; ?>,
                    Octubre:<?php echo $TREPLASOCTUBRE19; ?>,
                    Noviembre:<?php echo $TREPLASNOVIEMBRE19; ?>,
                    Diciembre:<?php echo $TREPLASDICIEMBRE19; ?>
        }],
        xkey: 'period',
