...
<?php
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Rejas de Madera</li>
                        </ol>
                    </div>
  ...
  <tbody>
    <tr>
      ...
      <td class="a2018 txtinfo4"><?php echo $TREMAENERO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAENERO19 ?></td>
    </tr>

    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">FEBRERO</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAFEBRERO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAFEBRERO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">MARZO</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAMARZO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAMARZO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">ABRIL</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAABRIL18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAABRIL19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">MAYO</th>

      <td class="a2018 txtinfo4"><?php echo $TREMAMAYO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAMAYO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">JUNIO</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAJUNIO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAJUNIO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">JULIO</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAJULIO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAJULIO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">AGOSTO</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAAGOSTO18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAAGOSTO19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">SEPTIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREMASEPTIEMBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMASEPTIEMBRE19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">OCTUBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREMAOCTUBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMAOCTUBRE19 ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">NOVIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREMANOVIEMBRE18  ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMANOVIEMBRE19  ?></td>
    </tr>
    <tr>
      <th scope="row" style="background: #EAEDED" class="subtitulos">DICIEMBRE</th>
      <td class="a2018 txtinfo4"><?php echo $TREMADICIEMBRE18 ?></td>
      <td class="a2019 txtinfo4"><?php echo $TREMADICIEMBRE19 ?></td>
    </tr>
    <tr>
      <th style="background: #1164F4; color: white;" scope="row">TOTAL</th>
      <td style="background: #A9CCE3; font-weight: bold;" class="txtinfo3"><?php echo $TREMA2018; ?></td>
      <td style="background: #A9CCE3; font-weight: bold;" class="txtinfo3"><?php echo $TREMA2019; ?></td>
    </tr>
  </tbody>
</table>
                    </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex no-block align-items-center">
                                    <h4 class="card-title">Rejas de Madera</h4>
                                    <div class="ml-auto">
    ...
    <script>
        ...
        data: [{
            period: '2018',
            Enero: <?php echo $TREMAENERO18; ?>,
                    Febrero: <?php echo $TREMAFEBRERO18; ?>,
                    Marzo: <?php echo $TREMAMARZO18; ?>,
                    Abril: <?php echo $TREMAABRIL18; ?>,
                    Mayo: <?php echo $TREMAMAYO18; ?>,
                    Junio: <?php echo $TREMAJUNIO18; ?>,
                    Julio: <?php echo $TREMAJULIO18; ?>,
                    Agosto:<?php echo $TREMAAGOSTO18; ?>,
                    Septiembre:<?php echo $TREMASEPTIEMBRE18; ?>,
                    Octubre:<?php echo $TREMAOCTUBRE18; ?>,
                    Noviembre:<?php echo $TREMANOVIEMBRE18; ?>,
                    Diciembre:<?php echo $TREMADICIEMBRE18; ?>
        }, {
            period: '2019',
            Enero: <?php echo $TREMAENERO19; ?>,
                    Febrero: <?php echo $TREMAFEBRERO19; ?>,
                    Marzo: <?php echo $TREMAMARZO19; ?>,
                    Abril: <?php echo $TREMAABRIL19; ?>,
                    Mayo: <?php echo $TREMAMAYO19; ?>,
                    Junio: <?php echo $TREMAJUNIO19; ?>,
                    Julio: <?php echo $TREMAJULIO19; ?>,
                    Agosto:<?php echo $TREMAAGOSTO19; ?>,
                    Septiembre:<?php echo $TREMASEPTIEMBRE19; ?>,
                    Octubre:<?php echo $TREMAOCTUBRE19; ?>,
                    Noviembre:<?php echo $TREMANOVIEMBRE19; ?>,
                    Diciembre:<?php echo $TREMADICIEMBRE19; ?>
        }],
        xkey: 'period',
