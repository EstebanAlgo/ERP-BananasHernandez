...
$('#buscar').on('keyup', function(){
    ...
    .fail(function(){
      alert('Hubo un error al cargar los paises de destino')
    })
  })


$('#actualizar_vehiculos').on('click', function(){
  
 $.ajax({

    type: 'POST',
    url: 'views/combobox-certificado/vista-vehiculos.php'
  })
  .done(function(vehiculos){
    $('#vehiculo').html(vehiculos)
    
  })
  .fail(function(){
    alert('Hubo un error al cargar los vehiculos')
  })
   
  })

$('#actualizar_chofer').on('click', function(){
  
 $.ajax({

    type: 'POST',
    url: 'views/combobox-certificado/vista-chofer.php'
  })
  .done(function(choferes){
    $('#chofer').html(choferes)
    
  })
  .fail(function(){
    alert('Hubo un error al cargar los choferes')
  })
