...
if($_POST)
                  {
                     ...
                     $statement=$conexion->prepare("SELECT *FROM usuarios WHERE id_usuario='$responsable'");
                         $statement->execute();
                         $fincas=$statement->fetchAll();
                          foreach ($fincas as $fila) 
                         {
                             $usuario_capturista=$fila['usuario'];
                             $nombre=$fila['nombre'];
                             $p_apellido=$fila['p_apellido'];
                             $s_apellido=$fila['s_apellido'];
                             $tipo_usuario_capturista=$fila['tipo_usuario'];
                             $rfc=$fila['rfc'];
...
<head>
    ...
    <title>Perfil de Capturista</title>
    <!-- Bootstrap Core CSS -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-primary">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Perfil de  <?php echo $nombre." ".$p_apellido." ".$s_apellido; ?></h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <p class="form-control-static"> <?php echo $p_apellido.' '.$s_apellido; ?> </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <p class="form-control-static label label-primary"> <?php echo $tipo_usuario_capturista; ?> </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <p class="form-control-static"> <?php echo $nacimiento; ?> </p>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
