...
<body class="fix-header fix-sidebar card-no-border">
 ...
 <!-- Row -->
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-warning">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Configurar Perfil</h4>
                            </div>
                            <div class="card-body">
                                <form action="actualizar.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                        <input type="text" class="form-control" placeholder="Inserta el nombre de usuario" name="usuario" value="<?php echo $usuario; ?>" readOnly>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" placeholder="Inserta el Nombre" name="nombre" value="<?php echo $nombre; ?>" value="<?php echo $nombre; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info"></label>
                                                    <div class="col-md-7">
                                                        <a href="password.php" class="btn btn-outline-danger btn-block"><i class="fas fa-unlock-alt"></i> Cambiar Contraseña</a>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                        <div class="form-group row ">
                                            <label class="control-label text-right col-md-2 text-info">Tipo de usuario</label>
                                                    <div class="col-md-10">
                                                        <span class="label label-primary"><?php echo $tipo_usuario; ?></span>
                                                    </div>
                                    </div>
                                    </div>
                                        ...
                                        <div class="row">
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-2">
                                                <img class="img-fluid img-thumbnail" src="<?php echo $image_perfil ?>" alt="Usuario">
                                            </div>
                                            <!--/span-->
                                        </div>
                                        <div class="row align-items-center">
                                            ...
                                            <div class="col-md-10">
                                                <div class="form-group row has-info">
                                                    <label class="control-label text-right col-md-2 text-success">TEMA: </label>
                                                    
                        <div class="r-panel-body">
                            <ul id="themecolors" class="m-t-20">
                                <li><b>Barra Clara</b></li>
                                <li><a id="default" href="javascript:void(0)" onclick="tema(this.id)" data-theme="default" class="default-theme">1</a></li>
                                <li><a id="green" href="javascript:void(0)" onclick="tema(this.id)" data-theme="green" class="green-theme">2</a></li>
                                <li><a id="red" href="javascript:void(0)" onclick="tema(this.id)" data-theme="red" class="red-theme">3</a></li>
                                <li><a id="blue" href="javascript:void(0)" onclick="tema(this.id)" data-theme="blue" class="blue-theme">4</a></li>
                                <li><a id="purple" href="javascript:void(0)" onclick="tema(this.id)" data-theme="purple" class="purple-theme">5</a></li>
                                <li><a id="megna" href="javascript:void(0)" onclick="tema(this.id)" data-theme="megna" class="megna-theme">6</a></li>
                                <li class="d-block m-t-30"><b>Con Barra Oscura</b></li>
                                <li><a id="default-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="default-dark" class="default-dark-theme">7</a></li>
                                <li><a id="green-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="green-dark" class="green-dark-theme">8</a></li>
                                <li><a id="red-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="red-dark" class="red-dark-theme">9</a></li>
                                <li><a id="blue-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="blue-dark" class="blue-dark-theme">10</a></li>
                                <li><a id="purple-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="purple-dark" class="purple-dark-theme">11</a></li>
                                <li><a id="megna-dark" href="javascript:void(0)" onclick="tema(this.id)" data-theme="megna-dark" class="megna-dark-theme ">12</a></li>
                            </ul>
                        </div>
                                                  <input type="hidden" value="css/colors/megna-dark.css" id="tema" name="tema">  
                                               </div>
                                            </div>
                                            <!--/span-->
                                            <!--/span-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <button  class="btn btn-info"> <i class="far fa-check-circle"></i> Actualizar</button>
    ...
    <script>
        function tema(tema)
        {
           $("#tema").attr("value","css/colors/"+tema+".css");
        }
