                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Imprimir Solicitud</li>
                        </ol>
                    </div>
...
$id_solicitante=$fila['id_usuario'];
$nombre_solicitante=$fila['nombre']." ".$fila['p_apellido']." ".$fila['s_apellido'];


$statement=$conexion->prepare("SELECT * FROM solicitud WHERE usuario=$id_solicitante");
$statement->execute();
$solicitante=$statement->fetchAll();

if(count($solicitante)>0)
{
 
 foreach ($solicitante as $fila2) {

$id_finca=$fila2['id_finca'];
...
if ($fechapiv!=$fecha) {
     $Filas.="<tr>
                ...
                <td><span class='label label-table label-success'>PENDIENTE</span></td>                
                <td>$dia/$mes/$año</td>

                <td>
                     <form action='imprimir_solicitud.php' method='POST' style='display:inline-block;'>
                     
                     <input type='hidden' name='finca' value='$id_finca'>
                     <input type='hidden' name='solicitante' value='$id_solicitante'>
                     <input type='hidden' name='fecha' value='$fecha'>
                     
                    <button class='btn btn-info '><i class='fas fa-file-pdf'></i> Generar Solicitud</button>
                     </form>
                </td>
          </tr>";
}
...
?>
                ...
                <div class="card card-outline-inverse">
                            <div class="card-body">
                                <h4 class="card-title">SOLICITUDES DE COMPRA</h4>
                                <h6 class="card-subtitle">Desglose de Pedidos de Material</h6>
                                     <div class="card">
                                                    ...
                                                    <table id="demo-foo-accordion" class="table table-bordered m-b-0 toggle-arrow-tiny" data-filtering="true" data-paging="true" data-sorting="true" data-paging-size="7">
                                                        <thead>
                                                            <tr class="footable-filtering">
                                                                <th data-toggle="true"> FINCA </th>
                                                                <th> SOLICITANTE </th>
                                                                <th data-hide="all"> STATUS </th>
                                                                <th data-hide="all"> FECHA </th>
                                                                <th data-hide="false">Acción</th>
                                                            </tr>
                                                        </thead>
                                                        <tbody>
