							...
							<div class="card-outline-info">
                                  ...
                                  <h4 class="text-white">BANANAS HERNANDEZ</h4>
                                    ...
                                    <div class="card-body bg-light">
                                        <h3 class="card-title">SOLICITUD DE MATERIAL</h3>
                                        <hr>
                                        ...
                                        <div class="row m-t-15">
                                        	<div class="col-12 col-md-6">
                                        		<label class="control-label text-right col-md-5 text-info" class="selectpicker" data-style="btn-info btn-outline-primary btn-block">Producto:</label>
                                ...
                                <label class="control-label">Unidad</label>
                                        ...
                                        <div class="row m-t-15">
                                        	<div class="col">
                                        		<label class="control-label text-right col-md-5 text-info" class="selectpicker" data-style="btn-info btn-outline-primary btn-block">Finca:</label>
...
$.ajax({
      type: 'POST',
      url: 'complementos/solicitud.php'
    })
    .done(function(x){
      $('#resultado').html(x)
    })
...
$('#agregar').on('click', function(){
    ...
    var fecha= $('#fecha').val()
     if (cantidad=="") {
        swal("DATOS VACIOS!", "Inserta cantidad de productos que desea solicitar.")
    }
    else{
    $.ajax({
      type: 'POST',
      url: 'complementos/solicitud.php',
      data: {'cantidad': cantidad,'producto':producto,'finca':finca,'fecha':fecha}
    })
    .done(function(x){
      $('#resultado').html(x)
       swal("REGISTRO EXITOSO!", "Solicitud agregada exitosamente","success")
    })
    .fail(function(){
      //alert('Hubo un error al cargar los municipios')
    })}
