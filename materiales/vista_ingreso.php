                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Registro de Ingresos</li>
                        </ol>
                    </div>
...
foreach ($cobros as $fila) {
  ...
  $Filas.="<tr>
                ...
                <td>
                     ...
                     <input type='hidden' id='id_proveedor$id_ingreso' value='$proveedor'>
                     <input type='hidden' id='id_material$id_ingreso' value='$producto'>
                     <input type='hidden' id='cantidad$id_ingreso' value='$cantidad'>
                     <input type='hidden' id='unidad$id_ingreso' value='$unidad'>
                     <input type='hidden' id='id_finca$id_ingreso' value='$destino'>
                     
                     


                     <span onClick='editar(this.id)' class='btn btn-outline-info' id='$id_ingreso' data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i> Editar </span>
                     </form>
                     <form action='complementos/delete.php' method='post' style='display:inline-block;'>
                     <input type='hidden' name='id' value='$id_ingreso'>
...
<div class="row">
    ...
    <div class="col-12 col-md-8">
        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Registro de ingresos</h4>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control" id="input_proveedor" name="id_proveedor">

                                                        <label for="recipient-name" class="control-label">Producto:</label>
                                                        <input type="text" class="form-control" id="input_producto" name="id_material">
                                                        ...
                                                        <input type="text" class="form-control" id="input_destino" name="id_origen">
...
<!-- /.modal -->
    ...
    <script>
      ...
      {   
         ...
         var nombre=$('#id_proveedor'+id).val()
         ...
         $("#input_proveedor").attr("value",nombre)
