...
foreach ($cobros as $fila) {
  ...
  $Filas.="<tr>
                ...
                <td>
                     <form id='id_proveedor' style='display:inline-block;'>
                     <input type='hidden' id='nombre$id_proveedor' value='$nombre_proveedor'>
                     <span onClick='editar(this.id)' class='btn btn-outline-info' id='$id_proveedor' data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i> Editar </span>
                     </form>
...
<div class="row">
    ...
    <div class="col-12 col-md-8">
        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Alta de proveedores</h4>
