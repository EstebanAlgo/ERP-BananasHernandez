                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Registro de Egreso</li>
                        </ol>
                    </div>
...
foreach ($cobros as $fila) {
  ...
  $Filas.="<tr>
                ...
                <td>
                     ...
                     <input type='hidden' id='id_material$id_egreso' value='$producto'>
                     <input type='hidden' id='cantidad$id_egreso' value='$cantidad'>
                     <input type='hidden' id='unidad$id_egreso' value='$unidad'>
                     <input type='hidden' id='id_finca$id_egreso' value='$destino'>
                     
                     


                     <span onClick='editar(this.id)' class='btn btn-outline-info' id='$id_egreso' data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i> Editar </span>
                     </form>
                     <form action='complementos/delete.php' method='post' style='display:inline-block;'>
                     <input type='hidden' name='id' value='$id_egreso'>
                     <input type='hidden' name='accion' value='egresos'>
