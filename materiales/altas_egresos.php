               ...
               <div class="container">
                     <div class="row">
                        ...
                        <div class="card-body bg-light">
                            <h3 class="card-title">EGRESO DE MATERIAL</h3>
                                        <hr>
                            <div class="row">
                        <div class="col-12">
                            <div class="row">
                        ...
                        <div class="row m-t-15">
                            <div class="col-12 col-md-6">
                                <label class="control-label text-right">Producto:</label>
                                <select id="producto"  class="btn btn-info btn-outline-primary btn-block"> 
                                                    <?php 
                            ...
                            <div class="col-12 col-md-3">
                                ...
                                <input type="text" class="form-control" placeholder="Inserte la cantidad de articulos" id="cantidad">
                            </div>
                            <div class="col-12 col-md-3">
                                <label class="control-label">Unidad</label>
                                <select name="unidad" id="unidad"> <?php 
                                                                $statement=$conexion->prepare('SELECT *FROM material ORDER BY unidad ASC');
                                                                $statement->execute();
                                                                ...
                                                                foreach ($fincas as $fila) {
                                                                  $unidad=$fila['unidad'];
                                                                  $id_material=$fila['id_material'];
                                                                  echo "<option value='$id_material'>$unidad</option>";
                                                                }
                        ...
                        <div class="row align-items-center m-t-15" >
                            <div class="col-12 col-md-6">
                                 <label class="control-label text-info">Destino:</label>
                                 <select id="finca" class="btn btn-info btn-outline-primary btn-block"> 
                                                    <?php 
                            ...
                            <div class="col-12 col-md-6">
                                <button type="submit" class="btn btn-success btn-block" id="agregar" style="margin-bottom: -30px;"> <i class="fa fa-check" ></i> AGREGAR</button>
                            </div>
                        </div>
                        </div>
                         ...
                         <div class="col-7">
                            ...
                            <div class="col bg-light" id="resultado">
                         </div>
...
$('#agregar').on('click', function(){
    ...
    if (cantidad=="") {
        swal("DATOS VACIOS!", "Inserta la cantidad de productos.")
    }
    else  {
        $.ajax({
      type: 'POST',
      url: 'complementos/egresos.php',
      data: {'cantidad': cantidad,'producto':producto,'unidad':unidad,'finca':finca,'fecha':fecha}
    })
    .done(function(x){
      $('#resultado').html(x)
      swal("REGISTRO EXITOSO!", "Registro de egresos guardado","success")
    })
    .fail(function(){
      //alert('Hubo un error al cargar los municipios')
    })
