                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Añadir Nueva Categoría</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Inserte categoria" id="nombre">
                                                     </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="col-5" style="display: inline-block;">
                                            <a  href="vista_categoria.php" class="btn btn-lg btn-outline-info mytooltip"><i class="fas fa-people-carry"></i> Categorias<span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">Vista de todas las<br /> categorias registradas</span></span></span></a>
...
$.ajax({
      type: 'POST',
      url: 'complementos/categoria.php'
    })
    .done(function(x){
      $('#resultado').html(x)
    })
...
$('#agregar').on('click', function(){
   ...
   if (nombre=="") {
    ...
    .done(function(x){
      $('#resultado').html(x)
        swal("REGISTRO EXITOSO!", "categoria agregada exitosamente","success")
    })
    .fail(function(){
      //alert('Hubo un error al cargar los municipios')
    })
