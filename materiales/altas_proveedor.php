                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Alta de Nuevo Proveedor</li>
                        </ol>
                    </div>
					...
					<div class="row">
                        ...
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">BANANAS HERNANDEZ</h4>
                            </div>
                            <div class="card-body">
                                        ...
                                        <div class="row p-t-20">
                                            <div class="col-md-6">
                                                <div class="form-group">
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Inserte proveedor" id="nombre">
                                                     </div>
                                    ...
                                    <div class="form-actions">
                                        ...
                                        <div class="col-5" style="display: inline-block;">
                                            <a  href="vista_proveedor.php" class="btn btn-lg btn-outline-info mytooltip"><i class="fas fa-people-carry"></i> Proveedores<span class="tooltip-content5"><span class="tooltip-text3"><span class="tooltip-inner2">Vista de todos los<br /> proveedores registrados</span></span></span></a>
...
$.ajax({
      type: 'POST',
      url: 'complementos/proveedor.php'
    })
    .done(function(x){
      $('#resultado').html(x)
    })
...
$('#agregar').on('click', function(){
    ...
    if (nombre=="") {
        swal("DATOS VACIOS!", "Inserta nombre del proveedor.")
    }
    else{
    $.ajax({
      type: 'POST',
    ...
    .done(function(x){
      $('#resultado').html(x)
      swal("REGISTRO EXITOSO!", "Proveedor agregado exitosamente","success")
    })
    .fail(function(){
      //alert('Hubo un error al cargar los municipios')
    })}
