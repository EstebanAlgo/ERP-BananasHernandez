...
<body class="fix-header card-no-border logo-center">
 ...
 <?php 
    $Filas="";
$statement=$conexion->prepare("SELECT * FROM solicitud");
$statement->execute();
...
foreach ($cobros as $fila) {
  ...
  $destino=destino($conexion,$fila['id_finca']);
  ...
  $Filas.="<tr>
                ...
                <td>
                     ...
                     <input type='hidden' id='id_solicitud$id_solicitud' value='$id_solicitud'>
                     <input type='hidden' id='id_material$id_solicitud' value='$producto'>
                     <input type='hidden' id='unidad$id_solicitud' value='$unidad'>
                     <input type='hidden' id='cantidad$id_solicitud' value='$cantidad'>
                     <input type='hidden' id='id_finca$id_solicitud' value='$destino'>


                     <span onClick='editar(this.id)' class='btn btn-outline-info' id='$id_solicitud' data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i> Editar </span>
                     </form>
...
<div class="row">
    ...
    <div class="col-12 col-md-8">
        <div class="card">
                            <div class="card-body">
                                <h4 class="card-title">Relacion de solicitudes</h4>
                                        ...
                                        <div class="modal-content">
                                            ...
                                            <div class="modal-body">
                                                    ...
                                                    <div class="form-group">
                                                        <label for="recipient-name" class="control-label">Folio de solicitud:</label>
                                                        <input type="text" class="form-control" id="input_id_solicitud" name="id_solicitud">

                                                        <label for="recipient-name" class="control-label">Producto:</label>
                                                        <input type="text" class="form-control" id="input_producto" name="producto">
                                                        ...
                                                        <input type="text" class="form-control" id="input_cantidad" name="cantidad">

                                                        <label for="recipient-name" class="control-label">Destino:</label>
                                                        <input type="text" class="form-control" id="input_destino" name="destino">
...
<!-- /.modal -->
    ...
    <script>
      function editar(id)
      {   
         var id_solicitud=$('#id_solicitud'+id).val()
         var producto=$('#id_material'+id).val()
         var unidad=$('#unidad'+id).val()
         var cantidad=$('#cantidad'+id).val()
         var destino=$('#id_finca'+id).val()
 


         $("#input_id_solicitud").attr("value",id_solicitud)
         $("#input_producto").attr("value",producto)
         $("#input_unidad").attr("value",unidad)
         $("#input_cantidad").attr("value",cantidad)
         $("#input_destino").attr("value",destino)
