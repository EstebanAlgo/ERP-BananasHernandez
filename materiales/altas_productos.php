...
<body class="fix-header card-no-border logo-center">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Alta de Nuevo Producto</li>
                        </ol>
                    </div>
                            ...
                            <div class="card-body bg-light">
                                ...
                                <div class="row m-t-15">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" placeholder="Inserte nombre del producto" id="nombre">
                                    </div>
                                    <div class="col">
                                        <label class="control-label">Descripción</label>
                                        <input type="text" class="form-control" placeholder="Inserte descripción del producto" id="descripcion">
                                    </div>
                                ...
                                <div class="row m-t-15">
                                    <div class="col">
                                        ...
                                        <input type="text" class="form-control" placeholder="Inserte unidad" id="unidad">
                                    </div>
                                    <div class="col">
                                        <label class="control-label">Limite de Stock</label>
                                        <input type="text" class="form-control" placeholder="Inserte Limite de Stock" id="limite">
                                    </div>
                                ...
                                <div class="row m-t-15 ">
                                    ...
                                    <div class="col text-right">
                                        ...
                                        <select id="categoria" class="form-control col-md-6 btn btn-info btn-outline-primary ">
                                            <?php
    ...
    <script>
        $.ajax({
                type: 'POST',
                url: 'complementos/productos.php'
            })
            .done(function(x) {
                $('#resultado').html(x)
            })
        ...
        $('#agregar').on('click', function() {
            ...
            if (nombre == "") {
                ...
                $.ajax({
                    ...
                    .done(function(x) {
                        $('#resultado').html(x)
                        swal("REGISTRO EXITOSO!", "producto agregado exitosamente", "success")
                    })
                    .fail(function() {
                        //alert('Hubo un error al cargar los municipios')
                    })
