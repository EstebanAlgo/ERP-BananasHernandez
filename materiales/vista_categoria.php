        ...
        <div class="page-wrapper">
            ...
            <div class="container-fluid">
                ...
                <td>
                     ...
                     <input type='hidden' id='nombre$id_categoria' value='$nombre_categoria'>
                     <span onClick='editar(this.id)' class='btn btn-outline-info' id='$id_categoria' data-toggle='modal' data-target='#modal-actualizar' > <i class='fas fa-pencil-alt'></i> Editar </span>
                     </form>
