...
foreach ($cobros as $fila) {
  ...
  $id_material=material($conexion,$fila['id_material']);
  $cantidad=$fila['cantidad'];
  $id_finca=finca($conexion,$fila['id_finca']);
  ...
  $Filas.="<tr>
                ...
                <td>
                     ...
                     <input type='hidden' id='id_material$id_egreso' value='$id_material'>
                     <input type='hidden' id='cantidad$id_egreso' value='$cantidad'>
                     <input type='hidden' id='unidad$id_egreso' value='$unidad'>
                     <input type='hidden' id='id_finca$id_egreso' value='$id_finca'>
