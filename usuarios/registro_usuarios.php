...
<body class="fix-header fix-sidebar card-no-border">
 ...
 <!-- Row -->
                        ...
                        <div class="card card-outline-primary">
                            ...
                            <div class="card-body">
                                <form action="registro_usuarios.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        <div class="offset-1 offset-md-10 col-10 col-md-2 m-b-20">
                                                <a href="../usuarios/" class="btn btn-info btn-block "><i class="fas fa-users"></i> Usuarios</a>
                                            </div>
    ...
    <!-- ============================================================== -->
    <script>
        <?php if ($confirmacion>0) {
            echo "swal('HECHO!', 'Usuario Agregado Exitosamente', 'success')";
        } ?>
    </script>
