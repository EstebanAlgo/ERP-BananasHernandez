                    ...
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <div class="row ">
                                  <div class="col-12 col-md-2 offset-0 offset-md-10">
                                    <a class="btn btn-inverse btn-sm btn-block" href="registro_usuarios.php"><i class="fas fa-user-plus"></i> AGREGAR USUARIO</a>
                                  </div>
                                  
                                </div>
                                
                                <div class="col-12">
                                    <table class="table table-striped table-sm table-hover table-responsive" style="text-align: center; width: 100%;" id="myTable">
                                        <thead style="background: #223870; color: white;">
                                            <tr>
                                                <th>Usuario</th>
                                                <th>Tipo</th>
                                                <th>Nombre</th>
                                        ...
                                        <tbody  style="color: black; font-size: 0.8em;">
                                    <?php 
                        //Consultas en mysql------------------------------------------------------------------------------------
                         ...
                         foreach ($usuarios as $fila) 
                         {
                          $tipo_usuario=$fila['tipo_usuario'];
                             ...
                             if ($tipo_usuario=="Administrador") {
                               echo '<td>'."<span class='label label-info'>".$fila['tipo_usuario']."</span>".'</td>';
                             }
                             else{
                              echo '<td>'."<span class='label label-primary'>".$fila['tipo_usuario']."</span>".'</td>';
                             }
