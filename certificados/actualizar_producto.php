...
if($_POST)
                        ...
                        //Consultas en mysql------------------------------------------------------------------------------------
                         $statement=$conexion->prepare('SELECT *FROM producto WHERE id_producto=:id');
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-danger">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Actualizar información del producto "<?php echo $producto; ?>"</h4>
                            </div>
                            <div class="card-body">
                                <form action="actualizando_datos_producto.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">Producto:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo $producto ?>" placeholder="Inserta el nombre del Producto" name="producto" required> 
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">Descripción:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" value="<?php echo $descripcion; ?>" placeholder="Inserta la descripción" name="descripcion" required> 
                                                    </div>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../images/certificados/productos.jpg" alt="Producto">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
