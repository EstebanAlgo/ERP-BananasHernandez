                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Formato de descarga</li>
                        </ol>
                    </div>
...
<div class="row items-align-center">
          ...
          <form action="reporte_excel.php" method="post">
            <input type="hidden" name="reporte" value="<?php echo $tipo_reporte; ?>">
            <input type="hidden" name="buscar" value="<?php echo $valor; ?>">
            <input type="hidden" name="fecha1" value="<?php echo $fecha1; ?>">
            <input type="hidden" name="fecha2" value="<?php echo $fecha2; ?>">
            <button class="btn btn-success btn-lg btn-block" title="Generar excel">
              <i style="font-size: 4em;" class="fas fa-file-excel"></i><br>DESCARGAR EXCEL
            </button>
          </form>   
        </div>
        <div class="col-12 col-md-6">
          <form action="formato_reporte.php" method="post">
            <input type="hidden" name="reporte" value="<?php echo $tipo_reporte; ?>">
            <input type="hidden" name="buscar" value="<?php echo $valor; ?>">
            <input type="hidden" name="fecha1" value="<?php echo $fecha1; ?>">
            <input type="hidden" name="fecha2" value="<?php echo $fecha2; ?>">
            <button class="btn btn-danger btn-lg btn-block" title="Generar PDF">
              <i style="font-size: 4em;" class="fas fa-file-pdf"></i><br>IMPRIMIR PDF 
            </button>
          </form>
        </div>
        </div>
