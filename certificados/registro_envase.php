                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Añadir Nuevo Envase</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Añadir Nuevo Envase</h4>
                            </div>
                            <div class="card-body">
                                <form action="envases.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del envase" name="envase" required> 
                                                    </div>
                                    ...
                                    <select class="selectpicker" data-style="btn-info btn-outline-primary btn-block" required name="tipo_envase">
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-2">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/envases.jpg" alt="Remitente">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
