...
if ($tipo_usuario=="null" OR $tipo_usuario=="Productor") 
 ...
 if($_POST)
 {
  ...
  $remitente=$_POST['remitente'];
    ...
    $registrar_remitente=$conexion->prepare("INSERT INTO remitente(id_remitente,empresa,domicilio,fecha_registro,id_usuario) VALUES 
                                               (null,'$remitente','$domicilio',null,'$id_usuario')");
    $registrar_remitente->execute();

    echo "<script>alert('Remitente registrado exitosamente');</script>";
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Remitentes</li>
                        </ol>
                    </div>
 ...
 <!-- column -->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Administrador de remitentes</h6>
                         ...
                         <?php 
            //Consultas en mysql------------------------------------------------------------------------------------
                         $statement=$conexion->prepare('SELECT *FROM remitente');
                         $statement->execute();
  ...
  <form class='dropdown-item' style='display:inline-block;' action='../views/perfil_capturista.php' method='post'>
          ...
          <button data-toggle='tooltip' title='Capturista' class=' btn btn-outline-info btn-block'><i class='fas fa-address-card'></i></button>
                           ...
                           $accion.="<form class='dropdown-item' style='display:inline-block;' action='actualizar_remitente.php' method='post'>
          <input type='hidden' value='$id_remitente' name='id_remitente'>
  ...
  <form class='dropdown-item' style='display:inline-block;' action='borrar_remitente.php' method='post'>
          <input type='hidden' value='$id_remitente' name='id_remitente'>
