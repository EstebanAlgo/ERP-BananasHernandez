            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Destinos</a></li>
                            <li class="breadcrumb-item active">Añadir Nuevo Destino</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Añadir Nuevo Destino</h4>
                            </div>
                            <div class="card-body">
                                <form action="destinos.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">Destino:</label>
                                                    <div class="col-md-9">
                                                     <input type="text" class="form-control" placeholder="Inserta el nombre del destino" name="destino" required>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-5 text-info" class="selectpicker" data-style="btn-info btn-outline-primary btn-block">País:</label>
                                                    <div class="col-md-7">
                                        <select id="pais" name="pais" class="btn btn-info btn-outline-primary btn-block"></select>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6" >
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info">Estado:</label>
                                                    <div class="col-md-7">
                                        <select id="ciudad" name="ciudad" class="btn btn-info btn-outline-primary btn-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-2 text-info">Dirección:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Dirección del destino" name="direccion" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/destinos.jpg" alt="Destinos">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
