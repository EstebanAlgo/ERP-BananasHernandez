...
if($_POST)
{
    $id_remitente=$_POST['id_remitente'];
        ...
        //Consultas en mysql------------------------------------------------------------------------------------
         $statement=$conexion->prepare('SELECT *FROM remitente WHERE id_remitente=:id');
         $statement->execute( array(':id' => $id_remitente));
         $remitente=$statement->fetchAll();
             

         foreach ($remitente as $fila) 
         {
...
<head>
    ...
    <title>Registro de Remitentes</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Añadir Nuevo Remitente</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-danger">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Actualizar datos del Remitente "<?php echo $empresa; ?>"</h4>
                            </div>
                            <div class="card-body">
                                <form action="actualizando_datos_remitente.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">REMITENTE:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del Remitente" name='empresa' value="<?php echo $empresa; ?>"required> 
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del Remitente"name='domicilio' value="<?php echo $domicilio; ?>" required> 
                                                    </div>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../images/certificados/remitente.png" alt="Remitente">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <input name ='id_remitente' type='hidden' value="<?php echo $id_remitente; ?>">
