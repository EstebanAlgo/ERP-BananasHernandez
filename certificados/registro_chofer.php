                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Añadir Nuevo Chofer</li>
                        </ol>
                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">NOMBRE:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del Chofer" name="nombre" required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info offset-2">Licencia:</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" placeholder="Inserta la Licencia de conducir" name="licencia" required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">Estado:</label>
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el Estado" name="estado" required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta la dirección" name="direccion" required> 
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/conductor.jpg" alt="Remitente">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
