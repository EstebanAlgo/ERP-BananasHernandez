...
if ($tipo_usuario=="null" OR $tipo_usuario=="Productor") 
 ...
 if($_POST)
 {
  ...
  $producto=$_POST['producto'];
    ...
    $registrar_producto=$conexion->prepare("INSERT INTO producto (id_producto,producto,descripcion,fecha_registro,id_usuario) VALUES 
                                               (null,'$producto','$descripcion',null,'$id_usuario')");
    $registrar_producto->execute();
 ...
 <!-- column -->
                    <div class="col-12">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h6 class="card-subtitle">Administrador de Productos</h6>
  ...
  <form class='dropdown-item' style='display:inline-block;' action='../views/perfil_capturista.php' method='post'>
          ...
          <button data-toggle='tooltip' title='Capturista' class=' btn btn-outline-info btn-block'><i class='fas fa-address-card'></i></button>
                           ...
                           $accion.="<form class='dropdown-item' style='display:inline-block;' action='actualizar_producto.php' method='post'>
  ...
  <form class='dropdown-item' style='display:inline-block;' action='borrar_producto.php' method='post'>
          <input type='hidden' value='$id_producto' name='id_producto'>
