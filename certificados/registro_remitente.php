                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            ...
                            <div class="card-body">
                                <form action="remitentes.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del Remitente" name="remitente" required> 
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                                        <select  class="btn btn-outline-primary" id="estados" name="estado"  required></select>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6" >
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info">Ciudad:</label>
                                                    <div class="col-md-7">
                                                        <select id="municipios" name="municipio" class="btn btn-outline-primary" required>
                                        ...
                                        <!--/row-->
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/remitente.png" alt="Remitente">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
