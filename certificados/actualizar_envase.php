...
$nombre_envase="Por definir";
    if($_POST)
                                 {
                                    $id_envase=$_POST['id_envase'];
                                 
                        //Consultas en mysql------------------------------------------------------------------------------------
                         $statement=$conexion->prepare('SELECT *FROM envases WHERE id_envase=:id');
                         $statement->execute( array(':id' => $id_envase));
                         $envase=$statement->fetchAll();
             

                         foreach ($envase as $fila) 
                         {
                            
                            $envase=$fila['envase'];
                            $categoria=$fila['grafica'];
                            ...
                            switch ($categoria) {
                             case 'C':
                               ...
                               break;
                            case 'DEDO':
                               $nombre_envase="Dedo Suelto";
                               break;
                            case 'RA':
                               $nombre_envase="Racimos";
                               break;
                            case 'RE':
                               $nombre_envase="Rejas";
                               break;
                            case 'REMA':
                               $nombre_envase="Rejas de madera";
                               break;
                            case 'REPLAS':
                               $nombre_envase="Rejas de Plástico";;
                               break;
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Actualizar envase</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-danger">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Actualizar datos de Envase "<?php echo $envase; ?>"</h4>
                            </div>
                            <div class="card-body">
                                <form action="actualizando_datos_envase.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-4 text-info">Envase:</label>
                                                    <div class="col-md-8">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del envase" value="<?php echo $envase; ?>" name="envase" required> 
                                                    </div>
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-6 text-info">Tipo de envase:</label>
                                                    <div class="col-md-6">
                                        <select class="selectpicker" data-style="btn-info btn-outline-primary btn-block" required name="tipo_envase">
                        <option data-tokens="<?php echo $nombre_envase; ?>" value="<?php echo $categoria; ?>" ><?php echo $nombre_envase; ?></option>
                                            <option data-tokens="Cajas" value="C">Cajas</option>
                                            <option data-tokens="Rejas" value="RE">Rejas</option>
                                            <option data-tokens="Racimos" value="RA">Racimos</option>
                                            <option data-tokens="Dedo Suelto" value="DEDO">Dedo Suelto</option>
                                            <option data-tokens="Rejas de Madera" value="REMA">Rejas de Madera</option>
                                            <option data-tokens="Rejas de Plástico" value="REPLAS">Rejas de Plástico</option>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-2">
                                                <img class="img-fluid img-thumbnail" src="../images/certificados/envase.jpg" alt="Remitente">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <input name ='id_envase' type='hidden' value="<?php echo $id_envase; ?>">
