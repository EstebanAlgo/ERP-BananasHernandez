...
<head>
    ...
    <title>Registro de Orígen</title>
    <!-- Bootstrap Core CSS -->
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Añadir Nuevo Origen</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Añadir Nueva Finca</h4>
                            </div>
                            <div class="card-body">
                                <form action="fincas.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-9">
                                                     <input type="text" class="form-control" placeholder="Inserta el nombre de la finca" name="finca" required>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-7">
                                        <select id="estados" name="estado" class="btn btn-info btn-outline-primary btn-block"></select>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6" >
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-md-7">
                                        <select id="municipios" name="municipio" class="btn btn-info btn-outline-primary btn-block">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group row ">
                                                    ...
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" placeholder="Registro" name="reg_empacadora" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
            ...
            foreach ($fincas as $fila) 
                         {
                            ...
                            $productor=$fila['id_usuario'];
                             ...
                             echo "<option value='$productor'>$nombre $p_apellido $s_apellido</option>";
                         }
                    ...
                    ?>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-2">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/fincas.jpg" alt="ORIGEN">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
