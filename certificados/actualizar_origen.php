...
$nombre_productor="No Especifica";
$option_productor="";
$id_productor=0;
                        ...
                        //Consultas en mysql------------------------------------------------------------------------------------
                         ...
                         $statement->execute( array(':id' => $id_origen));
                         $finca=$statement->fetchAll();
             

                         foreach ($finca as $fila) 
                         {
                            
                            $finca=$fila['nombre_finca'];
                            $estado=$fila['entidad'];
                            $municipio=$fila['municipio'];
                            $reg_empacadora=$fila['registro_empacadora'];
            ...
            $statement=$conexion->prepare("SELECT *FROM usuarios WHERE tipo_usuario='Productor' ORDER BY nombre ASC");
            $statement->execute();
            ...
            foreach ($fincas as $fila) 
                         {
                            ...
                            $productor=$fila['id_usuario'];

                             $option_productor.="<option value='$productor'>$nombre $p_apellido $s_apellido</option>";
                             if ($productor==$id_productor) {
                                $nombre_productor="$nombre $p_apellido $s_apellido";
                             }
                         }
...
<head>
    ...
    <title>Actualizar de Orígen</title>
    <!-- Bootstrap Core CSS -->
            ...
            <div class="container-fluid">
                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Origen</a></li>
                            <li class="breadcrumb-item active">Actualizar Registro de Origen </li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-danger">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Actuzalizar Datos del Origen "<?php echo $finca; ?>"</h4>
                            </div>
                            <div class="card-body">
                                <form action="actualizando_datos_origen.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-2 text-info">Origen:</label>
                                                    <div class="col-md-9">
            <input type="text" class="form-control" placeholder="Inserta el nombre de la finca" name="finca" value="<?php echo $finca; ?>" required>
                                                    </div>
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-5 text-info" class="selectpicker" data-style="btn-info btn-outline-primary btn-block">Estado:</label>
                                                    <div class="col-md-7">
                                       <input type="text" class="form-control" placeholder="Inserta el estado" name="estado" value="<?php echo $estado; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            <div class="col-md-6" >
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info">Municipio:</label>
                                                    <div class="col-md-7">
                                        <input type="text" class="form-control" placeholder="Inserta el muinicipio" name="municipio" value="<?php echo $municipio; ?>" required>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-md-7">
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info">Registro de empacadora:</label>
                                                    <div class="col-md-7">
                                                        <input type="text" class="form-control" placeholder="Registro" name="reg_empacadora" value="<?php echo $reg_empacadora; ?>" required>
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
                                            ...
                                            <div class="col-md-5">
                                                <div class="form-group row ">
                                                    <label class="control-label text-right col-md-5 text-info">Productor:</label>
                                                    <div class="col-md-7">
        <select required class="selectpicker" data-style="btn-info btn-outline-success btn-block" name="productor">
                    <option>Selecciona un Productor</option>
                    <option selected value="<?php echo $id_productor; ?>"><?php echo $nombre_productor; ?></option>
                    <?php  
                            echo $option_productor;
                    ?>
                 </select>
                                                    </div>
                                                </div>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-2">
                                                <img class="img-fluid img-thumbnail" src="../images/certificados/plataneros.jpg" alt="Fincas">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
                                            ...
                                            <div class="col-md-6">
                                                <div class="row">
                                                    <div class="col-md-offset-3 col-md-9">
                                                        <input name ='id_origen' type='hidden' value="<?php echo $id_origen; ?>">
                                                        <button type="submit" class="btn btn-danger"> <i class="fas fa-sync-alt"></i> Actualizar</button>
