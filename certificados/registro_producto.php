                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-info">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Añadir Nuevo Producto a transportar</h4>
                            </div>
                            <div class="card-body">
                                <form action="productos.php" class="form-horizontal" method="post">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta el nombre del Producto" name="producto" required> 
                                                    </div>
                                            ...
                                            <div class="col-md-12">
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-md-10">
                                                        <input type="text" class="form-control" placeholder="Inserta la descripción" name="descripcion" required> 
                                                    </div>
                                          ...
                                          <div class="row align-items-center">
                                            ...
                                            <!--/span-->
                                            <div class="col-md-3">
                                                <img class="img-fluid img-thumbnail" src="../assets/images/gallery/producto.png" alt="Producto">
                                            </div>
                                            <!--/span-->
                                        </div>
                                          <!--/row-->
