                ...
                <div class="row page-titles">
                    <div class="col-md-5 col-8 align-self-center">
                        ...
                        <ol class="breadcrumb">
                            ...
                            <li class="breadcrumb-item active">Corrección de folios</li>
                        </ol>
                    </div>
                    ...
                    <div class="col-lg-12">
                        <div class="card card-outline-inverse">
                            <div class="card-header">
                                <h4 class="m-b-0 text-white">Foliación</h4>
                            </div>
                            <div class="card-body">
                                    <div class="form-body">
                                        ...
                                        <div class="row">
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-5 text-info">Folios:</label>
                                                    <div class="col-md-7">
                    <select class="selectpicker" data-style="btn-info btn-outline-info btn-block" required  id="tipo">
                        <option selected>Selecciona el tipo de Folio a buscar</option>
                        <option value="origen">Certificado de Origen</option>
                        <option value="responsiva">Carta responsiva</option>
                        <option value="clorinacion">Certificado de clorinación</option>
                    </select>      
                                            ...
                                            <div class="col-md-6">
                                                <div class="form-group row">
                                                    <label class="control-label text-right col-md-5 text-info">Inserta el folio:</label>
                                                    <div class="col-md-7">
                                                     <input type="text" class="form-control" placeholder="Folio" aria-label="Folio" aria-describedby="basic-addon1" id="valor">
                                                    </div>
                                                </div>
                                            </div>
                                            <!--/span-->
...
function pregunta(e){ 
   if (confirm('¿Esta seguro de que desea ELIMINAR el Certificado seleccionado?')){ 
