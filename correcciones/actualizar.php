...
$cloro=$_POST['cloro'];
$tipo=$_POST['tipo'];
$piv_origen=$_POST['origen'];
$piv_responsiva=$_POST['responsiva'];
$piv_cloro=$_POST['cloro'];
}
  ...
  <script type="text/javascript">
   $("#barra_navegacion").load('<?php echo $menu; ?>');
      ...
      <div class="row">
        ...
        <div class="col-12 col-md-6 offset-md-3">
          <div class="input-group mb-3">
              <div  class="input-group-prepend">
                <span style="background: #85C1E9; font-weight: bold;" class="input-group-text" id="basic-addon1">Folio <?php echo $tipo; ?></span>
              </div>
              <?php 
              switch ($tipo) {
                case 'origen':
                  echo "<input style='text-align: center; font-weight: bold;' type='number' class='form-control' placeholder='Folio inserta un folio' value='$origen' id='update'>";
                  echo "<input type='hidden' value='$tipo' name='tipo' id='tipo'>
                        <input type='hidden' value='$responsiva' name='responsiva' id='valor2'>
                        <input type='hidden' value='$cloro' name='cloro' id='valor3'>
                        <input type='hidden' value='$piv_origen' id='piv1'>
                        <input type='hidden' value='$piv_responsiva' id='piv2'>
                        <input type='hidden' value='$piv_cloro' id='piv3'>";
                   break;
                case 'responsiva':
                  echo "<input style='text-align: center; font-weight: bold;' type='number' class='form-control' placeholder='Folio inserta un folio' value='$responsiva' id='update'>";
                  echo "<input type='hidden' value='$tipo' name='tipo' id='tipo'>
                        <input type='hidden' value='$cloro' name='cloro' id='valor3'>
                        <input type='hidden' value='$piv_origen' id='piv1'>
                        <input type='hidden' value='$piv_responsiva' id='piv2'>
                   ...
                   break;
                case 'clorinacion':
                  echo "<input style='text-align: center; font-weight: bold;' type='number' class='form-control' placeholder='Folio inserta un folio' value='$cloro' id='update'>";
                  echo "<input type='hidden' value='$tipo' name='tipo' id='tipo'>
                        <input type='hidden' value='$responsiva' name='responsiva' id='valor3'>
                        <input type='hidden' value='$piv_origen' id='piv1'>
                        <input type='hidden' value='$piv_responsiva' id='piv2'>
                        <input type='hidden' value='$piv_cloro' id='piv3'>";
                   break;
        ...
        if($tipo=="responsiva" OR $tipo=="clorinacion"){
        echo "
        <div class='col-12 col-md-6 offset-md-3'>
          <div class='input-group mb-3'>
              <div class='input-group-prepend'>
                <span style='background: #82E0AA; font-weight: bold;' class='input-group-text' id='basic-addon1'>Certificado de origen al que pertenece</span>
              </div>
              <input style='text-align: center; font-weight: bold;' type='number' class='form-control' placeholder='inserta un folio' value='$origen' id='valor2'>
          </div>
        </div>";
        }
        ...
        <div class="col-12" id="actualizacion">
